...
Alternatively, you can {apm-guide-ref}/aws-lambda-secrets-manager.html[use the AWS Secrets Manager to store your APM authentication key] (i.e. the _APM Secret Token_ or the _APM API key_) instead of providing the secret value as plaintext in the environment variables.
