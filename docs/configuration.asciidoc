...
[float]
[[config-django-instrument-commands]]
==== `django_instrument_commands`
|============
| Environment                               | Django                       | Default
| `ELASTIC_APM_DJANGO_INSTRUMENT_COMMANDS`  | `DJANGO_INSTRUMENT_COMMANDS` | `True`
|============

By default, Elastic APM instruments Django management commands.
You can disable this by setting this setting to `False`.
