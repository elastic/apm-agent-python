...
test:
	...
	py.test -v $(PYTEST_ARGS) $(PYTEST_MARKER) --junitxml=/app/tests/.junit.xml; \
	else py.test -v $(PYTEST_ARGS) $(PYTEST_MARKER) --junitxml=/app/tests/.junit.xml --ignore=tests/asyncio; fi
