...
ERRORS_SCHEMA = 'https://raw.githubusercontent.com/elastic/apm-server/6.1/docs/spec/errors/payload.json'
TRANSACTIONS_SCHEMA = 'https://raw.githubusercontent.com/elastic/apm-server/6.1/docs/spec/transactions/payload.json'
