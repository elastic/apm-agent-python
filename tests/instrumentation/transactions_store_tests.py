...
from elasticapm.traces import Tracer, capture_span, context
...
def test_get_transaction():
    ...
    assert t == context.get_transaction()


def test_get_transaction_clear():
    requests_store = Tracer(lambda: [], lambda: [], lambda *args: None)
    t = requests_store.begin_transaction("test")
    assert t == context.get_transaction(clear=True)
    assert context.get_transaction() is None
